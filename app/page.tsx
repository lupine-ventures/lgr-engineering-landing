    ...
    <main>
      <section className="hero" aria-label="LRG Engineering tap plans">
        ...
        <div className="heroContent" id="top">
          ...
          <div className="heroActions">
            <a className="button primary" href="mailto:tapplan@lrgengineering.com">
              Start a tap plan
            </a>
      ...
      <section className="split section" id="process">
        <div>
          ...
          <p className="muted">
            ...
            review. This redesign makes that specialty clear fast: LRG is the
            partner that turns those moving parts into a coordinated plan set.
          </p>
        </div>
      ...
      <section className="contact" id="contact">
        ...
        <div className="contactPanel">
          <a href="mailto:tapplan@lrgengineering.com">tapplan@lrgengineering.com</a>
